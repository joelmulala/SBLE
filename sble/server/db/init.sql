...
DROP TABLE IF EXISTS audit_logs, announcements, discussions, rooms, exams, quiz_attempts, quiz_questions, quizzes, submissions, assignments, materials, enrollments, courses, users CASCADE;
...
-- Users (JWT auth; created via register/login)
CREATE TABLE users (
...
-- Course learning modules (Canvas/Moodle-style organization)
...
-- Academic calendar custom events (office hours, milestones)
