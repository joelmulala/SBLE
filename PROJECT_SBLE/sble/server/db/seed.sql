...
-- Run: mysql -u sble_user -psble_password_2024 sble_db < server/db/seed.sql
...
(1,'Security Threat Analysis','Identify and analyse three real-world cybersecurity threats.','2026-05-10 23:59:00',1,'l0000001-0000-0000-0000-000000000001'),
(1,'Firewall Configuration Report','Document a firewall rule set for a small business network.','2026-05-24 23:59:00',1,'l0000001-0000-0000-0000-000000000001'),
(2,'React Component Design','Build a reusable authenticated component using React and Keycloak.','2026-05-12 23:59:00',0,'l0000001-0000-0000-0000-000000000002'),
(2,'REST API Implementation','Implement a secure REST API with Express and JWT.','2026-05-26 23:59:00',0,'l0000001-0000-0000-0000-000000000002'),
(3,'ER Diagram Design','Design a normalised ER diagram for a university system.','2026-05-08 23:59:00',1,'l0000001-0000-0000-0000-000000000003'),
(3,'SQL Query Optimisation','Write and optimise 10 complex SQL queries.','2026-05-22 23:59:00',0,'l0000001-0000-0000-0000-000000000003'),
(4,'Process Scheduling Simulation','Simulate FCFS and Round Robin scheduling algorithms.','2026-05-14 23:59:00',0,'l0000001-0000-0000-0000-000000000004'),
(4,'Memory Management Essay','Compare paging and segmentation memory management.','2026-05-28 23:59:00',1,'l0000001-0000-0000-0000-000000000004'),
(5,'Network Topology Design','Design a secure network topology for a campus.','2026-05-09 23:59:00',1,'l0000001-0000-0000-0000-000000000005'),
(5,'Packet Analysis Report','Analyse a provided PCAP file and identify anomalies.','2026-05-23 23:59:00',0,'l0000001-0000-0000-0000-000000000005'),
(6,'Agile Sprint Plan','Create a sprint plan for a software project using Scrum.','2026-05-11 23:59:00',1,'l0000001-0000-0000-0000-000000000006'),
(6,'Design Patterns Report','Explain and implement three GoF design patterns.','2026-05-25 23:59:00',0,'l0000001-0000-0000-0000-000000000006'),
(7,'Search Algorithm Implementation','Implement A* and compare with BFS and DFS.','2026-05-13 23:59:00',0,'l0000001-0000-0000-0000-000000000007'),
(7,'ML Model Evaluation','Train and evaluate a classification model on a dataset.','2026-05-27 23:59:00',0,'l0000001-0000-0000-0000-000000000007'),
(8,'Sorting Algorithm Analysis','Implement and benchmark five sorting algorithms.','2026-05-07 23:59:00',0,'l0000001-0000-0000-0000-000000000008'),
(8,'Graph Traversal Report','Implement BFS and DFS and analyse time complexity.','2026-05-21 23:59:00',0,'l0000001-0000-0000-0000-000000000008'),
(9,'Cloud Architecture Design','Design a scalable cloud architecture for an LMS.','2026-05-15 23:59:00',1,'l0000001-0000-0000-0000-000000000009'),
(9,'Serverless Function Implementation','Deploy a serverless function and document the process.','2026-05-29 23:59:00',0,'l0000001-0000-0000-0000-000000000009'),
(10,'Mobile UI Prototype','Design and prototype a mobile app UI for SBLE.','2026-05-10 23:59:00',1,'l0000001-0000-0000-0000-000000000010'),
(10,'Cross-Platform Security Review','Review security considerations for React Native apps.','2026-05-24 23:59:00',1,'l0000001-0000-0000-0000-000000000010'),
(11,'Forensic Investigation Report','Conduct a mock forensic investigation on provided evidence.','2026-05-12 23:59:00',1,'l0000001-0000-0000-0000-000000000011'),
(11,'Chain of Custody Documentation','Document a complete chain of custody for digital evidence.','2026-05-26 23:59:00',1,'l0000001-0000-0000-0000-000000000011'),
(12,'RSA Encryption Implementation','Implement RSA encryption and decryption from scratch.','2026-05-08 23:59:00',0,'l0000001-0000-0000-0000-000000000012'),
(12,'Hash Function Analysis','Compare MD5, SHA-1, and SHA-256 with collision examples.','2026-05-22 23:59:00',0,'l0000001-0000-0000-0000-000000000012'),
(13,'Usability Test Report','Conduct a usability test on an existing web application.','2026-05-14 23:59:00',1,'l0000001-0000-0000-0000-000000000013'),
(13,'Accessibility Audit','Audit a website for WCAG 2.1 compliance.','2026-05-28 23:59:00',1,'l0000001-0000-0000-0000-000000000013'),
(14,'Penetration Test Report','Perform a penetration test on a provided test environment.','2026-05-09 23:59:00',1,'l0000001-0000-0000-0000-000000000014'),
(14,'Vulnerability Assessment','Identify and document vulnerabilities in a sample application.','2026-05-23 23:59:00',1,'l0000001-0000-0000-0000-000000000014'),
(15,'Research Proposal','Write a 1500-word research proposal on a computing topic.','2026-05-11 23:59:00',1,'l0000001-0000-0000-0000-000000000015'),
(15,'Literature Review','Conduct a literature review on blended learning security.','2026-05-25 23:59:00',1,'l0000001-0000-0000-0000-000000000015');
...
(1,1,'Cybersecurity Fundamentals Quiz',20,1,'l0000001-0000-0000-0000-000000000001'),
(2,2,'Web Development Concepts Quiz',25,1,'l0000001-0000-0000-0000-000000000002'),
(3,3,'Database Design Quiz',20,1,'l0000001-0000-0000-0000-000000000003'),
(4,4,'Operating Systems Quiz',30,1,'l0000001-0000-0000-0000-000000000004'),
(5,5,'Networking Protocols Quiz',25,1,'l0000001-0000-0000-0000-000000000005'),
(6,6,'Software Engineering Quiz',20,1,'l0000001-0000-0000-0000-000000000006'),
(7,7,'AI Concepts Quiz',30,1,'l0000001-0000-0000-0000-000000000007'),
(8,8,'Algorithms Quiz',25,1,'l0000001-0000-0000-0000-000000000008'),
(9,9,'Cloud Computing Quiz',20,1,'l0000001-0000-0000-0000-000000000009'),
(10,10,'Mobile Development Quiz',20,1,'l0000001-0000-0000-0000-000000000010'),
(11,11,'Digital Forensics Quiz',25,1,'l0000001-0000-0000-0000-000000000011'),
(12,12,'Cryptography Quiz',30,1,'l0000001-0000-0000-0000-000000000012'),
(13,13,'HCI Principles Quiz',20,1,'l0000001-0000-0000-0000-000000000013'),
(14,14,'Ethical Hacking Quiz',25,1,'l0000001-0000-0000-0000-000000000014'),
(15,15,'Research Methods Quiz',20,1,'l0000001-0000-0000-0000-000000000015');
...
(1,'Cybersecurity Final Exam','2026-06-10 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000001'),
(2,'Web Development Final Exam','2026-06-11 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000002'),
(3,'Database Systems Final Exam','2026-06-12 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000003'),
(4,'Operating Systems Final Exam','2026-06-13 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000004'),
(5,'Computer Networks Final Exam','2026-06-14 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000005'),
(6,'Software Engineering Final Exam','2026-06-15 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000006'),
(7,'Artificial Intelligence Final Exam','2026-06-16 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000007'),
(8,'Data Structures Final Exam','2026-06-17 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000008'),
(9,'Cloud Computing Final Exam','2026-06-18 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000009'),
(10,'Mobile Development Final Exam','2026-06-19 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000010'),
(11,'Digital Forensics Final Exam','2026-06-20 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000011'),
(12,'Cryptography Final Exam','2026-06-21 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000012'),
(13,'HCI Final Exam','2026-06-22 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000013'),
(14,'Ethical Hacking Final Exam','2026-06-23 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000014'),
(15,'Research Methods Final Exam','2026-06-24 09:00:00',120,0,'uploads/exams/placeholder.enc','l0000001-0000-0000-0000-000000000015');

-- ─── ROOMS (1 active per course) ─────────────────────────────────────────────
INSERT INTO rooms (course_id, title, room_token, created_by, is_active) VALUES
(1,'Cybersecurity Live Session','room-token-cs-001','l0000001-0000-0000-0000-000000000001',1),
(2,'Web Dev Live Session','room-token-wd-002','l0000001-0000-0000-0000-000000000002',1),
(3,'Database Live Session','room-token-db-003','l0000001-0000-0000-0000-000000000003',1),
(4,'OS Live Session','room-token-os-004','l0000001-0000-0000-0000-000000000004',1),
(5,'Networks Live Session','room-token-net-005','l0000001-0000-0000-0000-000000000005',1),
(6,'Software Eng Live Session','room-token-se-006','l0000001-0000-0000-0000-000000000006',1),
(7,'AI Live Session','room-token-ai-007','l0000001-0000-0000-0000-000000000007',1),
(8,'Algorithms Live Session','room-token-alg-008','l0000001-0000-0000-0000-000000000008',1),
(9,'Cloud Live Session','room-token-cloud-009','l0000001-0000-0000-0000-000000000009',1),
(10,'Mobile Dev Live Session','room-token-mob-010','l0000001-0000-0000-0000-000000000010',1),
(11,'Forensics Live Session','room-token-for-011','l0000001-0000-0000-0000-000000000011',1),
(12,'Cryptography Live Session','room-token-cry-012','l0000001-0000-0000-0000-000000000012',1),
(13,'HCI Live Session','room-token-hci-013','l0000001-0000-0000-0000-000000000013',1),
(14,'Ethical Hacking Live Session','room-token-eth-014','l0000001-0000-0000-0000-000000000014',1),
(15,'Research Methods Live Session','room-token-res-015','l0000001-0000-0000-0000-000000000015',1);
